"""Complete numeric output fields of Tushare fina_indicator, including non-default columns."""

FINA_INDICATOR_FIELDS = tuple("""
eps dt_eps total_revenue_ps revenue_ps capital_rese_ps surplus_rese_ps undist_profit_ps
extra_item profit_dedt gross_margin current_ratio quick_ratio cash_ratio invturn_days
arturn_days inv_turn ar_turn ca_turn fa_turn assets_turn op_income valuechange_income
interst_income daa ebit ebitda fcff fcfe current_exint noncurrent_exint interestdebt
netdebt tangible_asset working_capital networking_capital invest_capital retained_earnings
diluted2_eps bps ocfps retainedps cfps ebit_ps fcff_ps fcfe_ps netprofit_margin
grossprofit_margin cogs_of_sales expense_of_sales profit_to_gr saleexp_to_gr adminexp_of_gr
finaexp_of_gr impai_ttm gc_of_gr op_of_gr ebit_of_gr roe roe_waa roe_dt roa npta roic
...
debt_to_assets assets_to_eqt dp_assets_to_eqt ca_to_assets nca_to_assets tbassets_to_totalassets
...
q_netprofit_yoy q_netprofit_qoq equity_yoy rd_exp
""".split())
